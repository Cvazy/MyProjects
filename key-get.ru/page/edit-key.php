...
if ($_POST['up_key']) {
    ...
    $success = $db->prepare("UPDATE `key` SET key_product=? WHERE `id` = '$id' ");
    $success->execute([$key]);

    $_SESSION['message'] = 'Изменения сохранены! ';
    header("Location: account-edit?id=$id_product");
    exit;
}
        ...
        <div class="row">
            <div class="col-lg-6">
                <form action="" method="post">
                    ...
                    <br>
                    <input name="up_key" type="submit" class="btn btn-primary" value="сохранить">
                </form>

...
headerFUN('description', 'keywords', 'Добавление продукта');
...
<div class="col-lg-12">
    <div class="market_block_title">
        <h1 class="market_title">Добавление продукта </h1>
    </div>
            ...
            <div class="col-lg-12">
                <section class="card">
                    <div class="card-body text-secondary">
                        ...
                        <form action="addProductFunc" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="account_product_block">
                                ...
                                <div class="col-11 ">
                                    <textarea class="mytextarea"  name="manual"></textarea>
                                </div>
                            ...
                            <div class="account_product_block">
                                <div class="account_product_block_title add"> <input type="checkbox" id="checkbox"><b> Подарок</b></div>
                                <div class="col-11 " id="text" style="display: none">
                                     <textarea  class="mytextarea" name="prezent" >
                            ...
                            <div class="form-actions form-group">
                                <input type="submit" class="btn btn-primary btn-sm" name="add_product" value="добавить">
                            </div>

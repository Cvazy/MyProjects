                        ...
                        <div class="mySwiperOldProducts-block-content">
                            ...
                            <div class="mySwiperOldProducts-block-content-buttons">
                                ...
                                <div class="quantity_inner">
                                    ...
                                    <input type="text" value="1" size="2" class="qtty" data-max-count="20" />
                                ...
                                <script>
                                    // Получаем элементы кнопок и поля ввода
                                    const minusButton = document.querySelector('.bt_minus');
                                    const plusButton = document.querySelector('.bt_plus');
                                    const quantityInput = document.querySelector('.qtty');

                                    // Обработчик события при нажатии на кнопку уменьшения
                                    ...
                                    // Обработчик события при нажатии на кнопку увеличения
                                    plusButton.addEventListener('click', function() {
                                        // Получаем текущее значение поля ввода и максимально допустимое значение
                                        let currentValue = parseInt(quantityInput.value);
                                        let maxCount = parseInt(quantityInput.getAttribute('data-max-count'));

                                        // Увеличиваем значение на 1, если оно меньше максимального допустимого значения
